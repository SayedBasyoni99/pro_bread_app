          ...
          children: [
            ...
            Row(
              ...
              children: [
                const Text(
                  'بعد 45 دق',
                  style: TextStyle(color: AppConst.kPrimaryTextColor, fontWeight: FontWeight.bold, fontSize: 14),
                ),
                Gap(4.w),
                SvgPicture.asset(
            ...
            const Row(
              ...
              children: [
                Text(
                  'حدد اليوم',
                  style: TextStyle(color: AppConst.kThirdTextColor, fontSize: 12),
                ),
              ],
            ),
            Gap(24.h),
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: const Center(
                      child: Text(
                        ' 05:00 ',
                        style: TextStyle(color: AppConst.kPrimaryTextColor, fontSize: 12, fontWeight: FontWeight.bold),
                      ),
                    ),
                  );
                },
